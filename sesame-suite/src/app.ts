...
import { crmOrigineRouter } from "./routes/crmOrigine";
...
import { crmQualificationRouter } from "./routes/crmQualification";
...
export function createApp() {
  ...
  app.use("/wa", crmQualificationRouter);
